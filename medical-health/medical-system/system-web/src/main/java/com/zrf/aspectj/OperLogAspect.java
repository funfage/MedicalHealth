package com.zrf.aspectj;

import com.alibaba.fastjson.JSON;
import com.zrf.aspectj.annotation.Log;
import com.zrf.aspectj.enums.BusinessStatus;
import com.zrf.domain.OperLog;
...
import com.zrf.utils.ServletUtils;
...
public class OperLogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.zrf.aspectj.annotation.Log)")
