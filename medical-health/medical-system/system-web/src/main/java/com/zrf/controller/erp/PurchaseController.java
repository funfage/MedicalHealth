...
import com.zrf.domain.Purchase;
import com.zrf.domain.PurchaseItem;
...
public class PurchaseController extends BaseController {
    ...
    public AjaxResult listPurchaseForPage(PurchaseDto purchaseDto) {
        DataGridView gridView = purchaseService.listPurchasePage(purchaseDto);
